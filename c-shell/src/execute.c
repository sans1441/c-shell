...
static int isBuiltin(const char *name) { return strcmp(name, "hop") == 0 || strcmp(name, "reveal") == 0 || strcmp(name, "peek") == 0 || strcmp(name, "locate") == 0 || strcmp(name, "activities") == 0 || strcmp(name, "resume") == 0 || strcmp(name, "ping") == 0 || strcmp(name, "spy") == 0 || strcmp(name, "snoop") == 0; }
...
static int runBuiltin(const Command *command, ShellState *state) {
    ...
    if (strcmp(command->argv[0], "hop") == 0)
        ...
        spyRun(command);
    else if (strcmp(command->argv[0], "snoop") == 0)
        snoopRun(command);
